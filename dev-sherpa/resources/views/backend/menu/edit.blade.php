...
<div class="container">
    ...
    <div class="controls">
        ...
        <div class="radio">
            <label>
               {!! Form::radio('type', 'packages', (($menu->type == 'packages') ? true : false), array('id'=>'packages', 'class'=>'type')) !!}
                <span>Package</span>
            </label>
        </div>
        <br>
    ...
    <div style="display:none" class="control-group {!! $errors->has('url') ? 'has-error' : '' !!} url">
        ...
        <div class="controls">
            {!! Form::text('url',$menu->url, array('class'=>'form-control', 'id' => 'url', 'placeholder'=>'Url')) !!}
            @if ($errors->first('url'))
    ...
    <div class="control-group {!! $errors->has('package') ? 'has-error' : '' !!} package">
        ...
        <div class="controls">
            {!! Form::select('optionPackage', $optionsPackage, $menu->option, array('class'=>'form-control', 'id' => 'option', 'value'=>Input::old('option'))) !!}
