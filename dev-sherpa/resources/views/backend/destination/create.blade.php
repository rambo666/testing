...
@section('content')
    ...
    <section class="content-header">
        <h1> Destination <small> | Add Destination</small></h1>
        <ol class="breadcrumb">
            <li>
                <a href="{!! route(getLang() . '.admin.destination.index') !!}"><i class="fa fa-bus"></i> Destination</a>
            </li>
    ...
    <br>
        ...
        <div class="container">
        {!! Form::open(array('action' => '\Fully\Http\Controllers\Admin\DestinationController@store','id' => 'validate-form', 'files' => true)) !!}
            ...
            <div class="row control-group {!! $errors->has('title') ? 'has-error' : '' !!}">
                ...
                <div class="controls col-md-8">
                    {!! Form::text('title', null, array('class' => 'form-control', 'id' => 'title', 'placeholder' => 'Enter destination title', 'value' => Input::old('title'))) !!}
            ...
            <div class="row control-group {!! $errors->has('description') ? 'has-error' : '' !!}">
                ...
                <div class="controls col-md-8">
                    {!! Form::textarea('description', null, array('class' => 'form-control', 'id' => 'description', 'placeholder' => 'Enter destination description', 'value' => Input::old('description'))) !!}
            ...
            <div class="row">
                <div class="col-md-10">
                    {!! Form::submit('Add Destination', array('class' => 'btn btn-success')) !!}
                </div>
            </div>
