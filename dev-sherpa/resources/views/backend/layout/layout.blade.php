...
<head>
    ...
    <title>Dashboard | Sherpa Guide Nepal</title>
   ...
   <!--  used for settings -->
    <script src="{!! url('backend/js/settings.js') !!}" type="text/javascript"></script>
...
<div class="wrapper">
    <header class="main-header">
        <!-- Logo -->
        <a href="{!! url(getLang() . '/admin') !!}" class="logo"><b>Sherpa</b>Guide</a>
